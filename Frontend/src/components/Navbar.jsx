...
function Navbar() {
  ...
  const handleSearch = () => {
    if (searchText.trim()) {
      navigate(`/course?search=${encodeURIComponent(searchText.trim())}`);
    }
  };
        ...
        <div className="navbar ">
          ...
          <div className="navbar-end space-x-3">
            ...
            {authUser ? (
              <>
                {authUser.role === "admin" && (
                  <Link to="/admin" className="bg-pink-500 text-white px-3 py-2 rounded-md hover:bg-pink-700 duration-300 text-sm font-semibold">
                    Admin Panel
                  </Link>
                )}
